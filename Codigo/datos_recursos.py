...
def mej_civs(name):
    ...
    buff = {'aztecas': [1, 1, 1, 1, 1, 1, 1, 1],
            'celtas': [1.15, 1, 1, 1, 1, 1, 1, 1],
            'coreanos': [1, 1, 1.20, 1, 1, 1, 1, 1],
            'eslavos': [1, 1, 1, 1.15, 1, 1, 1, 1],
            'francos': [1, 1, 1, 1, 1, 1.25, 1, 1],
            'godos': [1, 1, 1, 1, 1, 1, 1, 1],
            'hunos': [1, 1, 1, 1, 1, 1, 1, 1],
            'ingleses': [1, 1, 1, 1, 1, 1.20, 1, 1],
            'mongoles': [1, 1, 1, 1, 1, 1, 1.50, 1],
            'turcos': [1, 1.20, 1, 1, 1, 1, 1, 1],
            'sin_mej': [1, 1, 1, 1, 1, 1, 1, 1]}
